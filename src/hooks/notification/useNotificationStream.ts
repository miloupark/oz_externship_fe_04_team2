...
import { alarmMapper, API_BASE_URL } from '@/constants'
...
export function useNotificationStream(options?: UseNotificationStreamOptions) {
  ...
  const accessToken = AuthStateStore((s) => s.accessToken)
  ...
  useEffect(() => {
    ...
    const streamUrl = `${API_BASE_URL}/api/v1/notifications/stream`
